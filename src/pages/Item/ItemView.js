...
// import styles from "./pages/Item/ItemView.module.css";
...
//   const onNavLinkContainer2Click = () => {
//     // Navigate to the "Bag" page or component
//     history.push("/bag");
//   };
...
//                   <img className={styles.icon} alt="" src="/star02.svg" />
//                   <img className={styles.icon} alt="" src="/star03.svg" />
//                   <img className={styles.icon} alt="" src="/star04.svg" />
